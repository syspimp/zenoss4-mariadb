...
/usr/bin/mysql -uroot -p$MYSQL_ROOT_PASSWORD -f -D zenoss_zep < /tmp/zenoss_zep.sql
/usr/bin/mysql -uroot -p$MYSQL_ROOT_PASSWORD -f -D zodb < /tmp/zodb.sql
/usr/bin/mysql -uroot -p$MYSQL_ROOT_PASSWORD -f -D zodb_session < /tmp/zodb_session.sql
